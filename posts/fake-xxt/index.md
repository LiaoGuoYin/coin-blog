...
![Split-Screen](./assets/fake-xxt_1.png)
...
![H5-Event](./assets/fake-xxt_2.png)
...
![fake-xxt-in-virtualvm.jpg](./assets/fake-xxt_3.jpg)
...
![look-at-touchbar.jpg](./assets/fake-xxt_4.jpg)
...
![Notification-Windows](./assets/fake-xxt_5.png)  ![Notification-macOS](./assets/fake-xxt_6.png)

### 秒刷不靠谱

在这里我选择全屏后台播放，而不是去用加速脚本秒过，这是因为在学习通后台服务器端，有一定的检测 `作弊机制`，对刷这个网课有一定了解的同学都知道：

![Fake-Detect](./assets/fake-xxt_7.png)
